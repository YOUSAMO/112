...
import com.example.member.DTO.CommentRequestDTO;
...
import com.example.member.entity.Animal; // Animal 엔티티 임포트 (추가)
import com.example.member.repository.BoardRepository;
import com.example.member.repository.CommentRepository;
import com.example.member.repository.ReplyRepository;
import com.example.member.repository.AdoptionReviewRepository;
import com.example.member.repository.AnimalRepository; // AnimalRepository 임포트 (추가)
